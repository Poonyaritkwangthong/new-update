            ...
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="doubleDropdownButton">
              ...
              <li>
                <a href="draw_list.php" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">productlistpage</a>
                    ...
                    <a href="admin_add.php" class="btn btn-link">เพิ่มบัญชี</a>
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql =  'SELECT * FROM users order by pr_id';
                                ...
                                while (($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) != NULL) {
                                    ...
                                    echo '<td>';
                            ?>
                                <a href="admin_edit.php?pr_id=<?php echo $row['pr_id'];?>" class="btn btn-warning">แก้ไข</a>
                                <a href="JavaScript:if(confirm('ยืนยันการลบ')==true){window.location='admin_delete.php?pr_id=<?php echo $row["pr_id"];?>'}" class="btn btn-danger">ลบ</a>
                            <?php
                                    echo '</td>';
                                    echo '</tr>';
                                }
